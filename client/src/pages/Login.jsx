...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
        try {
            e.preventDefault();   // when click on submit button it prevent the browser from reloading this webpage
        ...
        <div className='flex justify-center items-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
            ...
            <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    <p onClick={() => navigate('/reset-password')} className='text-right mb-4 text-indigo-500 cursor-pointer'>Forgot password?</p>
